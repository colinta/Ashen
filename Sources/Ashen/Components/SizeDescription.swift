...
public struct SizeDescription {
    ...
    public static func width(percent: Float = 100, times: Float = 1, plus: Int = 0, minus: Int = 0) -> SizeDescription {
        return SizeDescription(
            multiplier: FloatSize(width: times * percent / 100, height: 0),
            offset: Size(width: plus - minus, height: 1))
    }
    public func width(percent: Float = 100, times: Float = 1, plus: Int = 0, minus: Int = 0) -> SizeDescription {
        return SizeDescription(
    ...
    public static func height(percent: Float = 100, times: Float = 1, plus: Int = 0, minus: Int = 0) -> SizeDescription {
        return SizeDescription(
            multiplier: FloatSize(width: 0, height: times * percent / 100),
            offset: Size(width: 1, height: plus - minus))
    }
    public func height(percent: Float = 100, times: Float = 1, plus: Int = 0, minus: Int = 0) -> SizeDescription {
        return SizeDescription(
