...
struct InputViewSpecs: Spec {
    ...
    func run(expect: (String) -> Expectations, done: @escaping () -> Void) {
        ...
        withText(expect, "test", startingAt: (3, 0), pressing: .shiftLeft, goesTo: (3, -1))
        ...
        withText(expect, "test", startingAt: (3, 0), pressing: .shiftRight, goesTo: (3, 1))
        ...
        withText(expect, "12345\n1234567", startingAt: (8, 0), pressing: .shiftUp, goesTo: (8, -6))
        withText(expect, "12345\n1234567", startingAt: (8, -6), pressing: .shiftUp, goesTo: (8, -8))
        withText(expect, "12345\n1234567", startingAt: (13, 0), pressing: .shiftUp, goesTo: (13, -8))
        ...
        withText(expect, "12345\n12345678901234567890", startingAt: (0, 6), pressing: .shiftDown, goesTo: (0, 26))
        withText(expect, "12345\n12345678901234567890", startingAt: (6, 0), pressing: .shiftDown, goesTo: (6, 20))
        done()
    }
